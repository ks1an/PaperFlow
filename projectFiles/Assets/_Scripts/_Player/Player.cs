...
public sealed class Player : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        GameStateController.OnMenuStarted += SetPlayerOnMenu;
        GameStateController.OnGameStarted += SetPlayerOnStartGame;
        GameStateController.OnPlayStarted += SetMovementState;
        GameStateController.OnPauseStarted += SetIdleState;
