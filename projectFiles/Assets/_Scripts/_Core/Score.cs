...
public sealed class Score : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        GameStateController.OnGameStarted += SetCurrentScoreToZero;
        GameStateController.OnPauseStarted += SetScoreTextOnPause;
        GameStateController.OnPlayStarted += SetScoreTextOnPlay;
        GameStateController.OnGameOverStarted += TrySetNewRecord;
        #endregion
    }
