...
public sealed class Timer : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        GameStateController.OnGameStarted += StartTimer;
        GameStateController.OnPlayStarted += ResumeTimer;
        GameStateController.OnPauseStarted += PauseTimer;
        GameStateController.OnGameOverStarted += CompleteTimer;
        #endregion
    }
