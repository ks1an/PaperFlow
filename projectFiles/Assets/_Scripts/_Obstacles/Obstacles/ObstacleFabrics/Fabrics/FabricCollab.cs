...
public sealed class FabricCollab : ObstaclesFabric
{
    ...
    public override void CreateObjByRandom()
    {
        ...
        GameObject go = GameObject.Instantiate(prefab, pos, CachedMath.QuaternionIdentity, _container);
        #endregion
